...
`;function ic({isOpen:e,onClose:n}){return e?d.jsx("div",{className:"fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200",children:d.jsxs("div",{className:"bg-zinc-900 w-full max-w-lg max-h-[80vh] rounded-2xl border border-zinc-800 shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200",children:[d.jsxs("div",{className:"flex items-center justify-between px-6 py-4 border-b border-zinc-800 bg-zinc-900/50 sticky top-0 z-10",children:[d.jsxs("h2",{className:"text-xl font-bold text-white flex items-center gap-2",children:[d.jsx("span",{className:"w-2 h-2 rounded-full bg-neon-yellow animate-pulse"}),"업데이트 소식"]}),d.jsx("button",{onClick:n,className:"p-2 hover:bg-zinc-800 rounded-full transition-colors text-zinc-400 hover:text-white",children:d.jsx(_n,{size:20})})]}),d.jsx("div",{className:"flex-1 overflow-y-auto px-6 py-6 custom-scrollbar",children:d.jsx("div",{className:`prose prose-invert prose-zinc max-w-none 
            ...
            prose-ul:text-zinc-400 prose-li:my-1 prose-li:marker:text-neon-yellow/50`,children:d.jsx(Ju,{children:rc})})}),d.jsx("div",{className:"p-4 border-t border-zinc-800 bg-zinc-900/50",children:d.jsx("button",{onClick:n,className:"w-full bg-neon-yellow text-black font-bold py-3 rounded-xl hover:opacity-90 active:scale-[0.98] transition-all shadow-[0_0_20px_rgba(204,255,0,0.2)]",children:"확인했습니다"})})]})}):null}let gi="fade";function ac(e){gi=e}function kr(){return gi}function xi(){const e=it();return(n,t="fade")=>{ac(t),e(n)}}const bn=[{key:"dashboard",route:Y.crewDashboard},{key:"rank",route:Y.crewRank},{key:"squad",route:Y.crewSquad},{key:"profile",route:Y.crewProfile}];function lc(){const e=xi(),{pathname:n}=at(),t=j.useRef(null);j.useEffect(()=>{const r=n.match(/^\/crews\/([^/]+)\/([^/]+)/),i=r?.[1],a=r?.[2];if(!i||!a)return;const l=bn.findIndex(s=>s.key===a);if(l===-1)return;const o=s=>{if(s.touches.length!==1){t.current=null;return}const u=s.touches[0],c=u.target;let h=!1,p=c;for(;p&&p!==document.body;){if(p.tagName==="INPUT"||p.tagName==="TEXTAREA"||p.getAttribute("data-no-swipe")==="true"){h=!0;break}const x=window.getComputedStyle(p);if((x.overflowX==="auto"||x.overflowX==="scroll")&&p.scrollWidth>p.clientWidth+10){h=!0;break}p=p.parentElement}t.current={x:u.clientX,y:u.clientY,time:Date.now(),skip:h}},f=s=>{if(!t.current||t.current.skip){t.current=null;return}const u=s.changedTouches[0];if(!u)return;const c=u.clientX-t.current.x,h=u.clientY-t.current.y,p=Date.now()-t.current.time;if(t.current=null,Math.abs(c)>=55&&Math.abs(c)>Math.abs(h)*1.3&&p<=500){if(c<0){if(l<bn.length-1){const x=bn[l+1];e(se(x.route,{crewId:i}),"slide-left")}}else if(l>0){const x=bn[l-1];e(se(x.route,{crewId:i}),"slide-right")}}};return window.addEventListener("touchstart",o,{passive:!0}),window.addEventListener("touchend",f,{passive:!0}),()=>{window.removeEventListener("touchstart",o),window.removeEventListener("touchend",f)}},[n,e])}let rn=null;function oc(){return window.Kakao?Promise.resolve():rn||(rn=new Promise((e,n)=>{const t=document.createElement("script");t.src="https://t1.kakaocdn.net/kakao_js_sdk/2.7.2/kakao.min.js",t.crossOrigin="anonymous",t.onload=()=>e(),t.onerror=()=>{rn=null,n(new Error("Kakao SDK 로드 실패"))},document.head.appendChild(t)}),rn)}async function Fe(){const e="d7d9a271a55c37fda2ed03bec993af1e";try{return await oc(),window.Kakao.isInitialized()||window.Kakao.init(e),window.Kakao.isInitialized()}catch{return!1}}function sc(){Fe()}function pn(){return typeof navigator>"u"?!1:/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||!!navigator.maxTouchPoints&&navigator.maxTouchPoints>1}async function Pd({crewName:e,description:n,inviteCode:t,crewIconUrl:r,iconBlob:i}){const a="https://runc-app.github.io",l=`${a}/#${se(Y.invite,{code:t})}`,o=n?`${n}

초대 코드: ${t}`:`초대 코드: ${t}`,f=`[RUNC] ${e} 크루에 초대합니다!`,s=pn();if(s&&i&&typeof navigator<"u"&&navigator.share){const c=new File([i],"runc-crew-icon.jpg",{type:i.type||"image/jpeg"});if(navigator.canShare?.({files:[c]}))try{return await navigator.share({files:[c],title:f,text:`${e} 크루에 합류하세요!
${o}
${l}`,url:l}),"share"}catch(h){if(h instanceof Error&&(h.name==="AbortError"||h.message.includes("abort")||h.message.includes("canceled")||h.message.includes("cancel")))return"share"}}if(s&&typeof navigator<"u"&&navigator.share)try{return await navigator.share({title:f,text:`${e} 크루에 합류하세요!
${o}`,url:l}),"share"}catch(c){if(c instanceof Error&&(c.name==="AbortError"||c.message.includes("abort")||c.message.includes("canceled")||c.message.includes("cancel")))return"share"}if(await Fe())try{const c=r??(window.location.protocol==="https:"?`${a}/runc-icon.png`:void 0);return window.Kakao.Share.sendDefault({objectType:"feed",installTalk:!1,content:{title:`[RUNC] ${e} 크루에 초대합니다!`,description:o,...c&&{imageUrl:c},link:{mobileWebUrl:l,webUrl:l}},buttons:[{title:"RUNC 열기",link:{mobileWebUrl:l,webUrl:l}}]}),"kakao"}catch{}if(typeof navigator<"u"&&navigator.share)try{return await navigator.share({title:f,text:`${e} 크루에 합류하세요!
${o}`,url:l}),"share"}catch(c){if(c instanceof Error&&(c.name==="AbortError"||c.message.includes("abort")||c.message.includes("canceled")||c.message.includes("cancel")))return"share"}return await navigator.clipboard.writeText(`[RUNC] ${e} 크루에 합류하세요!
${o}
${l}`),"clipboard"}async function Td({runnerName:e,crewName:n,crewId:t,weekNumber:r,runNumber:i,distance:a,duration:l,pace:o,imageUrl:f,imageBlob:s}){const u="https://runc-app.github.io";let c=n;r&&i?c=`${n} ${r}주차 ${i}Run 완료`:r?c=`${n} ${r}주차`:i&&(c=`${n} ${i}Run 완료`);const h=new URLSearchParams;t&&h.set("crewId",t),h.set("crewName",n),h.set("runnerName",e),h.set("label",c),h.set("distance",String(a)),h.set("duration",l),o&&h.set("pace",o),f&&h.set("imageUrl",f);const p=`${u}/#${se(Y.shareRun,{})}?${h.toString()}`,x=o?` | ⚡ 페이스: ${o}/km`:"",y=`🏃‍♂️ ${e}님의 ${a}km 러닝 인증!`,_=`⏱️ 시간: ${l}${x}
🏆 ${c}`,w=pn();if(w&&s&&typeof navigator<"u"&&navigator.share){const S=new File([s],"runc-record.jpg",{type:s.type||"image/jpeg"});if(navigator.canShare?.({files:[S]}))try{return await navigator.share({files:[S],title:y,text:_}),"share"}catch($){if($ instanceof Error&&($.name==="AbortError"||$.message.includes("abort")||$.message.includes("canceled")||$.message.includes("cancel")))return"share"}}if(w&&typeof navigator<"u"&&navigator.share)try{return await navigator.share({title:y,text:_,url:p}),"share"}catch(S){if(S instanceof Error&&(S.name==="AbortError"||S.message.includes("abort")||S.message.includes("canceled")||S.message.includes("cancel")))return"share"}if(await Fe())try{const S=f||(window.location.protocol==="https:"?`${u}/runc-icon.png`:void 0);return window.Kakao.Share.sendDefault({objectType:"feed",installTalk:!1,content:{title:y,description:_,...S&&{imageUrl:S},link:{mobileWebUrl:p,webUrl:p}},buttons:[{title:"RUNC에서 러닝 보기",link:{mobileWebUrl:p,webUrl:p}}]}),"kakao"}catch{}if(typeof navigator<"u"&&navigator.share)try{return await navigator.share({title:y,text:_,url:p}),"share"}catch(S){if(S instanceof Error&&(S.name==="AbortError"||S.message.includes("abort")||S.message.includes("canceled")||S.message.includes("cancel")))return"share"}return await navigator.clipboard.writeText(`${y}
${_}
${p}`),"clipboard"}async function uc(e){if(!await Fe())return null;try{const t=e instanceof File?e:new File([e],"runc-weekly-goal.png",{type:"image/png"});return(await window.Kakao.Share.uploadImage({file:[t]}))?.infos?.original?.url??null}catch{return null}}async function Ad({runnerName:e,crewName:n,crewId:t,weekLabel:r,totalDistance:i,targetDistance:a,validRunCount:l,progress:o,averagePace:f,imageBlob:s}){const u=`[${n}] ${e}님 ${r} 미션 완료! 축하해 주세요 🎉`,c=pn();if(c&&s&&typeof navigator<"u"&&navigator.share){const p=new File([s],`runc-${r}-${e}.png`,{type:"image/png"});if(navigator.canShare?.({files:[p]}))try{return await navigator.share({files:[p],title:u,text:u}),"share"}catch(x){if(x instanceof Error&&(x.name==="AbortError"||x.message.includes("abort")||x.message.includes("canceled")||x.message.includes("cancel")))return"share"}}if(c&&typeof navigator<"u"&&navigator.share)try{return await navigator.share({title:u,text:u}),"share"}catch(p){if(p instanceof Error&&(p.name==="AbortError"||p.message.includes("abort")||p.message.includes("canceled")||p.message.includes("cancel")))return"share"}if(await Fe())try{let p;if(s){const w=await uc(s);w&&(p=w)}const x="https://runc-app.github.io",y=new URLSearchParams;t&&y.set("crewId",t),y.set("crewName",n),y.set("runnerName",e),y.set("weekLabel",r),i!==void 0&&y.set("totalDistance",String(i)),a!==void 0&&y.set("targetDistance",String(a)),l!==void 0&&y.set("validRunCount",String(l)),o!==void 0&&y.set("progress",String(Math.round(o))),f&&y.set("averagePace",f),p&&y.set("posterImageUrl",p);const _=`${x}/#${se(Y.shareGoal,{})}?${y.toString()}`;return window.Kakao.Share.sendDefault({objectType:"feed",installTalk:!1,content:{title:`[${n}] ${e}님`,description:`${r} 미션 완료! 축하해 주세요 🎉`,...p&&{imageUrl:p},link:{mobileWebUrl:_,webUrl:_}},buttons:[{title:"🔥 RUNC에서 확인하기",link:{mobileWebUrl:_,webUrl:_}}]}),"kakao"}catch{}if(typeof navigator<"u"&&navigator.share)try{return await navigator.share({title:u,text:u}),"share"}catch(p){if(p instanceof Error&&(p.name==="AbortError"||p.message.includes("abort")||p.message.includes("canceled")||p.message.includes("cancel")))return"share"}return await navigator.clipboard.writeText(u),"clipboard"}async function Rd({memberName:e,crewName:n,crewId:t,itemLabel:r,amount:i,detailText:a,settlement:l}){const o="https://runc-app.github.io",f=t?`${o}/#${se(Y.crewSquad,{crewId:t})}`:o,s=l?.bank&&l?.account?`
입금계좌: ${l.bank} ${l.account}${l.holder?` (${l.holder})`:""}`:"",u=`[${n}] ${e}님 ${r} 미납 안내`,c=`미납 ${r}: ${i.toLocaleString()}원${a?`
${a}`:""}${s}
정산소에서 확인 후 완납 부탁드립니다 🙏`;if(pn()&&typeof navigator<"u"&&navigator.share)try{return await navigator.share({title:u,text:`${c}
${f}`}),"share"}catch(x){if(x instanceof Error&&(x.name==="AbortError"||x.message.includes("abort")||x.message.includes("canceled")||x.message.includes("cancel")))return"share"}if(await Fe())try{return window.Kakao.Share.sendDefault({objectType:"feed",installTalk:!1,content:{title:u,description:c,link:{mobileWebUrl:f,webUrl:f}},buttons:[{title:"정산소에서 확인하기",link:{mobileWebUrl:f,webUrl:f}}]}),"kakao"}catch{}if(typeof navigator<"u"&&navigator.share)try{return await navigator.share({title:u,text:`${c}
${f}`}),"share"}catch(x){if(x instanceof Error&&(x.name==="AbortError"||x.message.includes("abort")||x.message.includes("canceled")||x.message.includes("cancel")))return"share"}return await navigator.clipboard.writeText(`${u}
${c}
${f}`),"clipboard"}async function Dd({memberName:e,crewName:n,crewId:t}){const r="https://runc-app.github.io",i=t?`${r}/#${se(Y.crewSquad,{crewId:t})}`:r,a=`[${n}] ${e}님 완납 확인!`,l=`${e}님, 벌금/회비 전액 완납 확인했습니다. 협조해주셔서 감사합니다 🙏🎉`;if(pn()&&typeof navigator<"u"&&navigator.share)try{return await navigator.share({title:a,text:`${l}
